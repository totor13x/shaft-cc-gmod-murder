SWEP.Base = "weapon_mu_knife_alice"

SWEP.ViewModel 				= "models/weapons/v_csgo_vorpalblade.mdl" //The model shown on your screen in first person.
...
SWEP.ENT 				= "mu_knife_alicedlc"

SWEP.VElements = {
	["DLC"] = { type = "Model", model = "models/weapons/w_csgo_vorpalbladedlc.mdl", bone = "v_weapon.knife", rel = "", pos = Vector(-0.2, 1, -3.5), angle = Angle(0, 0, -115), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["DLC"] = { type = "Model", model = "models/weapons/w_csgo_vorpalbladedlc.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0, 1, -1), angle = Angle(0, -90, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
function SWEP:Initialize()
	...
	weapons.Get("weapon_mu_knife_alice").Initialize(self)
...
if CLIENT then
	...
	function SWEP:UpdateBonePositions(vm)
	 ...
	 local blockscale = {
		//['EbonyBlade'] = Vector(0.01,0.01,0.01),
		['v_weapon.knife'] = Vector(0.01,0.01,0.01),
		//['ValveBiped.Bip01_R_Hand'] = Vector(0.01,0.01,0.01),
		['ValveBiped.Bip01_R_UpperArm'] = Vector(0,0,0),
		['ValveBiped.Bip01_R_Clavicle'] = Vector(0,0,0),
		['ValveBiped.Bip01_L_UpperArm'] = Vector(0,0,0),
		['ValveBiped.Bip01_L_Clavicle'] = Vector(0,0,0),
	 }
	function SWEP:ResetBonePositions(vm)
		...
		for i=0, vm:GetBoneCount() do
			...
			vm:ManipulateBoneScale( i, blockscale[vm:GetBoneName(i)] and blockscale[vm:GetBoneName(i)] or Vector(1, 1, 1) )
