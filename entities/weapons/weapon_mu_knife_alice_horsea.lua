...
--HobbyHorseA
SWEP.VElements = {
	["_FFFF3"] = { type = "Model", model = "models/hobbyhorsea.mdl", bone = "EbonyBlade", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 90, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["_FFFF2"] = { type = "Model", model = "models/hobbyhorsea.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3,1,-10), angle = Angle(180,180,0), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
