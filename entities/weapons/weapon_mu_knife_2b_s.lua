...
SWEP.VElements = {
	["2b_virtuos"] = { type = "Model", model = "models/kuma96/2b/beastlord/beastlord.mdl", bone = "EbonyBlade", rel = "", pos = Vector(15, 0, -6), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["2b_virtuos"] = { type = "Model", model = "models/kuma96/2b/beastlord/beastlord.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.596, 6.5, -10), angle = Angle(-90, 180, 90), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
