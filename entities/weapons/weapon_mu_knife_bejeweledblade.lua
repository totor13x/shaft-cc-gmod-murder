...
SWEP.ENT 					= "mu_knife_bejeweledblade"
...
SWEP.VElements = {
	["_FFFF3"] = { type = "Model", model = "models/deika/bejeweledblade.mdl", bone = "EbonyBlade", rel = "", pos = Vector(4,0.5,0), angle = Angle(0,180,0), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = nil }
}
SWEP.WElements = {
	["_FFFF2"] = { type = "Model", model = "models/deika/bejeweledblade.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.5,1.5,0), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = nil }
}
