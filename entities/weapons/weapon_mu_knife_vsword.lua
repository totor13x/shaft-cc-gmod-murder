...
SWEP.VElements = {
	["_FFFF3"] = { type = "Model", model = "models/epangelmatikes/vsword/vsword.mdl", bone = "EbonyBlade", rel = "", pos = Vector(12,0.5,0), angle = Angle(90,90,0), size = Vector(0.5,0.5,0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = nil }
}
SWEP.WElements = {
	["_FFFF2"] = { type = "Model", model = "models/epangelmatikes/vsword/vsword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.5,1.5,-9), angle = Angle(180, 90, -90), size = Vector(0.6,0.6,0.6), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = nil }
}
